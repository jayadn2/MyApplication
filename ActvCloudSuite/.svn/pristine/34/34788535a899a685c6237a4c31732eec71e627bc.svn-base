...
namespace ActvMvcClient.Models
{
    ...
    public partial class ActvMvcClientEntities : DbContext
    {
        public ActvMvcClientEntities()
            : base("name=ActvMvcClientEntities")
        {
        }
        ...
        public virtual DbSet<BillingFrequncyTable> BillingFrequncyTables { get; set; }
        ...
        public virtual int CompanyDetailsCreateProcedure()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CompanyDetailsCreateProcedure");
        }
    }
}
